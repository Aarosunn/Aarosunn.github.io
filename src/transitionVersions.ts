...
export type CubeVersion = { name: string; moves?: CubeMove[]; alg?: string; flip: number; stagger: number; open: number; gap: number; weld: number; note: string }
...
const ALG = { flip: 0.38, stagger: 0.08, open: 0.35, gap: 8, weld: 1.6 }
CUBE_VERSIONS.push(
