...
export function Site({ version: initial = 'v17', scheme = 'icemint', bg = '#07090c', floral, floralSeed = 3, flower }: { version?: string; scheme?: string; bg?: string; floral?: string; floralSeed?: number; flower?: string }) {
