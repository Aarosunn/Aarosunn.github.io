...
export const FLORAL_VERSIONS: FloralVersion[] = [
  ...
  { ...base, name: 'v16', kind: 'mesh', ruler: false, foliage: false, buds: false, pollen: false, wire: 0.12, fresnel: { power: 2.8, gain: 0.9, base: 0.015 }, irid: 0.25, blur: 2.5, dim: 0.55,
    scene: { flowers: [], ground: 'off', camDist: 4.6, place: [
      { flower: 'rose', at: [-0.42, 0.04, 0], scale: 0.8, rot: [-0.45, 0, 0.4], gain: 0.3, wire: 0.3 },
      { flower: 'lotus', at: [0.18, -0.18, 0.09], scale: 0.69, rot: [-1.49, 0.4, 0.35], gain: 0.3, wire: 0.4 },
      { flower: 'orchid', at: [0.02, -0.46, 0.35], scale: 0.58, gain: 1 },
    ] },
    note: 'v15 with the lotus where Aaron posed it (tab sliders, 2026-09-10): low in front, tipped well back, smaller' },
  { ...base, name: 'v17', kind: 'mesh', ruler: false, foliage: false, buds: false, pollen: false, wire: 0.12, fresnel: { power: 2.8, gain: 0.9, base: 0.015 }, irid: 0.25, blur: 2.5, dim: 0.55,
    scene: { flowers: [], ground: 'off', camDist: 4.6, place: [
      { flower: 'rose', at: [-0.42, 0.04, 0], scale: 0.8, rot: [-0.45, 0, 0.4], gain: 0.3, wire: 0.3 },
      { flower: 'lotus', at: [0.18, -0.18, 0.09], scale: 0.69, rot: [-1.49, 0.4, 0.35], gain: 0.3, wire: 0.4 },
      { flower: 'orchid', at: [-0.1, -0.43, 0.39], scale: 0.73, rot: [-0.06, 0.09, 0], gain: 1 },
    ] },
    note: 'v16 with the orchid where Aaron posed it: a little left and bigger, nearly straight on' },
  { ...base, name: 'v18', kind: 'mesh', ruler: false, foliage: false, buds: false, pollen: false, scheme: 'mint', petalWhite: 0.2, rimWhite: 0.6, wire: 0.12, fresnel: { power: 2.8, gain: 0.9, base: 0.015 }, irid: 0.25, blur: 2.5, dim: 0.55,
    scene: { flowers: [], ground: 'off', camDist: 4.6, place: [
      { flower: 'rose', at: [-0.42, 0.04, 0], scale: 0.8, rot: [-0.45, 0, 0.4], gain: 0.3, wire: 0.3 },
      { flower: 'lotus', at: [0.18, -0.18, 0.09], scale: 0.69, rot: [-1.49, 0.4, 0.35], gain: 0.3, wire: 0.4 },
      { flower: 'orchid', at: [-0.1, -0.43, 0.39], scale: 0.73, rot: [-0.06, 0.09, 0], gain: 1 },
    ] },
    note: 'v17 in mint: the mint scheme forced, petals leaning only 20% toward white, rims 60%' },
