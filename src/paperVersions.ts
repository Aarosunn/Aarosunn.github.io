...
PAPER_VERSIONS.push({ ...PAPER_VERSIONS[PAPER_VERSIONS.length - 1], name: 'v18', ascii: { ...PAPER_VERSIONS[PAPER_VERSIONS.length - 1].ascii!, color: '#2f9a80', color2: '#e8fbf5', fade: 0.3 }, note: "v17 with the glyphs a darker mint by the cube, blending to a near-white mint as they trail off (less density fade so the tips keep their light)" })
