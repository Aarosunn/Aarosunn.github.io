...
const fps = async (igpu, w, h, v = 'v10') => {
...
for (const [w, h] of [[1440, 900], [420, 820]]) for (const v of ['v10', 'v31', 'v24']) console.log(`${w}x${h} ${v}: rtx ${await fps(false, w, h, v)} fps, igpu ${await fps(true, w, h, v)} fps`)
